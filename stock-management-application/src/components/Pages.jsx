...
import Develop from "./InventoryLevel"
  ...
  return (
    <div className="bg-mybg h-screen w-full text-white overflow-hidden">
        <header className="bg-mycolor flex justify-between">
            ...
            <p className="self-center text-white font-bold">Stock Management Application - 
             <span className="text-yellow-400"> {currentPath}</span>  </p>
            <Link to="/" className="flex justify-center items-center">
                Logout<img src={icon_logout} alt="Kermen logo" className="w-10 p-2" />
            </Link>
        </header>
