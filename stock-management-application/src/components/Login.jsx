...
const Login = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (isAdmin === null) {
            ...
            axios
                .post("http://localhost:8800/api/auth/login", { username, password, isAdmin })
                .then((res) => {
    ...
    return (
        <div className="w-full h-screen bg-mycolor">
            <div className="md:flex sm:flex-row h-full md:p-10 p-5">
                <form onSubmit={handleSubmit} className="md:w-1/2 sm:w-full h-full  bg-mybg text-white flex justify-center items-center">
                    <div className="mx-5">
                        ...
                        <input type="text" id="username" value={username} onChange={(e) => setUsername(e.target.value)}
                            placeholder="Example: JohnTheBest" required
                        ...
                        <label htmlFor="password" className="text-xs mt-3">Password</label><br />
                        ...
                        <div className="mt-3">
                            ...
                            <label htmlFor="usertype" className="mr-3 ml-1 text-xs">Admin</label>
                            <input type="radio" 
                                name="type"
                                id="usertype1" 
                                className="bg-mybg opacity-35" 
                                ...
                                value="false"
                                onChange={handleOptionChange} />
                            <label htmlFor="usertype1" className="ml-1 text-xs">User</label>
                        </div><br />
                        <button type="submit" className="rounded-full bg-mybtn md:w-80 w-72 my-4 py-2.5 text-xs font-bold">Login</button>
                    </div>
                </form>
